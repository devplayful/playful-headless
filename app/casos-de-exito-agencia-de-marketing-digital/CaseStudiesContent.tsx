...
const caseStudies = [
  {
    ...
    slug: 'soytechno',
    description: 'SoyTechno, una empresa de tecnología, necesitaba mejorar su estrategia digital. Nos encargamos de frustrarse con la navegación y el proceso de compra era demasiado largo, lo que se traducía en ventas perdidas',
  ...
  },
  {
    ...
    slug: 'mercantil-sfi',
    description: 'Mercantil Servicios Financieros Internacional y la transformamos en una plataforma moderna que impulsa su presencia global y mejora la relación con sus clientes.',
  ...
  },
  {
    ...
    description: 'Banco Venezolano de Crédito Optimiza su plataforma y busca posicionarse para que más usuarios puedan encontrar más rápido en el sector financiero.',
  ...
  },
  {
    ...
    slug: 'odwalla',
    description: 'Odwalla, se renueva y se entra en el mundo de ecommerce con Shopify para ganar más paquete conversión y facilidad.',
  ...
  },
  {
    ...
    slug: 'jumex',
    description: 'Diseñamos un sistema de reservas intuitivo para reducir el abandono del carrito y mejorar la experiencia de usuario.',
    tags: ['E-commerce', 'Shopify', 'Analítica SEO', 'E-commerce'],
  ...
  },
  {
    ...
    slug: 'venemergencia',
    description: 'Grupo Venemergencia, una empresa de servicios de salud, necesitaba renovar su plataforma de ventas. Los usuarios se frustraban con la navegación y el proceso de compra era demasiado largo, lo que se traducía en ventas perdidas',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="text-white text-lg leading-relaxed opacity-90">
              Detrás de cada proyecto hay una historia de transformación. Nuestro trabajo se centra en identificar los puntos de dolor de tu negocio para luego aplicar la tecnología y la creatividad necesarias para generar resultados que no sólo resuelvan un problema, sino que impulsen tu crecimiento de manera sostenible.
            </p>
          </div>
      ...
      <div className="bg-[#E4FFF9] rounded-3xl mx-auto my-8 w-[71%]">
        ...
        {filteredCaseStudies.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-white/80">Intenta con otros filtros o <button 
              onClick={() => setActiveFilters([])}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="relative h-56 bg-gray-200 overflow-hidden group">
                ...
                {caseStudy.badge && (
                  <div className={`absolute bottom-4 left-4 ${caseStudy.badgeColor} text-white px-4 py-2 rounded-lg font-semibold text-sm shadow-lg`}>
                    {caseStudy.badge}
                  </div>
                )}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-center lg:space-x-12">
            ...
            <div className="lg:w-1/2 bg-[#FFEFD1] p-12 rounded-2xl text-center">
              ...
              Deja de arreglar tu web con parches y dejas de perder clientes por fallas que no puedes ver. Es hora de invertir en una solución profesional.
              </p>
