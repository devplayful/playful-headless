            ...
            <div className="w-80 max-w-[85%] h-full bg-[#3C009C] text-white shadow-2xl flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto py-4">
                <div className="space-y-1">
                  <Link 
                    href="/" 
                    className={`block px-6 py-3 text-sm font-semibold hover:bg-white/10 transition-colors ${isActive('/') ? 'bg-white/20' : ''}`}
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Inicio
                  </Link>
                  ...
                  <div>
                    <button
                      onClick={toggleCases}
                      className={`w-full text-left px-6 py-3 text-sm font-semibold flex justify-between items-center hover:bg-white/10 transition-colors ${isActive('/casos-de-exito') ? 'bg-white/20' : ''}`}
                    >
                    ...
                    {isCasesOpen && (
                      <div className="bg-[#2A0070] py-1 space-y-1">
                        <Link
                          href="/casos-de-exito-agencia-de-marketing-digital"
                          className="block px-8 py-2 text-sm hover:bg-white/10 transition-colors font-semibold"
                          onClick={() => setIsMenuOpen(false)}
                        >
                          Ver todos los casos
                        </Link>
                        {caseStudies.map((caseStudy) => {
                          ...
                          return (
                            <Link
                              key={caseStudy.id}
                              href={`/casos-de-exito/${caseStudy.slug}`}
                              className="block px-8 py-2 text-sm hover:bg-white/10 transition-colors uppercase"
                              onClick={() => setIsMenuOpen(false)}
                            >
                              {displayName}
                            </Link>
                  ...
                  <Link 
                    href="/nosotros" 
                    className={`block px-6 py-3 text-sm font-semibold hover:bg-white/10 transition-colors ${isActive('/nosotros') ? 'bg-white/20' : ''}`}
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Nosotros
                  </Link>
                  ...
                  <Link 
                    href="/blog" 
                    className={`block px-6 py-3 text-sm font-semibold hover:bg-white/10 transition-colors ${isActive('/blog') ? 'bg-white/20' : ''}`}
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Blog
                  </Link>
