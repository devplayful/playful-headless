...
const DEFAULT_SUBMIT_LABEL = '¡Quiero que conozcan mi caso!';
...
export default function ContactLeadForm({
  ...
  heading = (
    <h2 className="[font-family:var(--font-paytone-one),var(--font-montserrat),sans-serif] font-[700] text-[32px] leading-[40px] text-[#453A53] text-center w-[60%] mx-auto">
  ...
  return (
    <div className="bg-[#FF9294] rounded-[32px] shadow-xl p-8 md:p-10">
      ...
      <form id={formId} onSubmit={handleSubmit} className="space-y-6 [font-family:var(--font-dm-sans),sans-serif]">
        ...
        {isPendingConfirmation ? (
          ...
          <div>
            <button
              ...
              className="w-full bg-[#39DDCB] hover:bg-[#0c8966] text-[#440099] font-semibold py-3 px-6 rounded-full shadow-md transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isSubmitting ? 'Enviando...' : previewSimulation ? 'Ejecutar simulación segura' : submitLabel}
            </button>
          </div>
        )}
