...
9. Bajo exclusión mutua por contacto/pipeline, búsqueda y reutilización o creación en `Consulta` (priority) o `Revisar` (review/transition); checkpoint.
10. Solo si `priority`: bajo exclusión mutua por contacto/envío, búsqueda por marcador o creación de la tarea SLA; checkpoint. Review/transition no crean tarea.
